...
require 'block_editor/blocks/instagram'
...
module BlockEditor
  ...
  @@dynamic_blocks = ['BlockEditor::Blocks::Reusable', 'BlockEditor::Blocks::ContactForm', 'BlockEditor::Blocks::RecentPosts', 'BlockEditor::Blocks::Instagram']
